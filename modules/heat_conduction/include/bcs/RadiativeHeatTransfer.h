...
#ifndef RADIATIVEHEATTRANSFER_H
#define RADIATIVEHEATTRANSFER_H
...
template <>
InputParameters validParams<RadiativeHeatTransfer>();

/**
 * Generic gap heat transfer model, with h_gap =  h_conduction + h_contact + h_radiation
 */
class RadiativeHeatTransfer : public IntegratedBC
{
public:
  RadiativeHeatTransfer(const InputParameters & parameters);
