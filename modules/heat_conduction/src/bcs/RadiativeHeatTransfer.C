...
registerMooseObject("HeatConductionApp", RadiativeHeatTransfer);

template <>
InputParameters
validParams<RadiativeHeatTransfer>()
{
...
RadiativeHeatTransfer::RadiativeHeatTransfer(const InputParameters & parameters)
...
void
RadiativeHeatTransfer::initialSetup()
{
...
Real
RadiativeHeatTransfer::computeQpResidual()
{
  computeGapValues();
...
Real
RadiativeHeatTransfer::computeSlaveFluxContribution(Real grad_t)
{
  return _coord[_qp] * _JxW[_qp] * _test[_i][_qp] * grad_t;
}

Real
RadiativeHeatTransfer::computeQpJacobian()
{
  computeGapValues();
...
Real
RadiativeHeatTransfer::computeQpOffDiagJacobian(unsigned jvar)
{
  computeGapValues();
...
Real
RadiativeHeatTransfer::gapLength() const
{
  if (_has_info)
...
Real
RadiativeHeatTransfer::dgapLength(Real normalComponent) const
{
...
void
RadiativeHeatTransfer::computeGapValues()
{
  if (!_quadrature)
  {
    _has_info = true;
